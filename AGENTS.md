...
- После установки запускать тесты тем же интерпретатором: `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. dev-venv/bin/python -m pytest -q -p no:cacheprovider -W error tests`.
