...
Каждая вкладка ("секция" конфигурации) - управляется метаинформацией полей через файлы из папки [ui](../settings/ui). Пример файла: [remote_server.json](../settings/ui/remote_server.json)
