...
Виджет доступен для существующей задачи любого статуса, если есть сообщения; в WAIT/REVIEW он виден и с пустой историей, поскольку содержит форму комментария. При создании задачи виджет скрыт. На ширине более 700px расположен справа от полей, на меньшей ширине — под ними. Схема PNG показывает расположение, а текущие сообщения имеют фон, дату и кнопку копирования.
